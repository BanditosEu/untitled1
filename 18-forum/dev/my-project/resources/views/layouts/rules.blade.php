...
<head>
    ...
    <link rel="stylesheet" href="../../../public/js/ckeditor/plugins/prism/lib/prism/prism_patched.min.css">
        ...
        <div class="nav-wrapper white">
            <div class="container">
                ...
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    ...
                    <li>
                        <a href="/18-forum/dev/my-project/public" data-activates="theme-menu" class="dropdown-button">
    ...
    <div class="row first-row">
        <div class="card">
            <div class="card-content">
                <span class="card-title">Forumregels</span>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="../../../public/js/ckeditor/plugins/prism/lib/prism/prism_patched.min.js"></script>
